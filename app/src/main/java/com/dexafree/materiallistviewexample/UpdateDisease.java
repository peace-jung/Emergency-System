...
public class UpdateDisease extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                diaView = View.inflate(UpdateDisease.this, R.layout.input_disease, null);
                ...
                AlertDialog.Builder dlg = new AlertDialog.Builder(UpdateDisease.this);
                dlg.setTitle("추가 정보");
                dlg.setView(diaView);
        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UpdateDisease.HttpAsyncTask httpTask = new UpdateDisease.HttpAsyncTask(UpdateDisease.this);
                httpTask.execute("http://192.168.64.136:8080/EMIRS/InsertRecord", "");
                finish();
            }
        });
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        private UpdateDisease updateDisease;

        HttpAsyncTask(UpdateDisease updateDisease) {
        ...
        protected void onPostExecute(final String result) {
            ...
            updateDisease.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                }
            });
